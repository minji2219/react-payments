...
const TitleText = dt.h2`
	font-size: 18px;
	font-weight: 700;
`;
const Description$1 = ({ children, color = "#8B95A1" }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DescriptionText, { color, children });
};
const DescriptionText = dt.div`
...
const InputField = ({ label, children, errorMessage }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$3, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description$1, { color: COLORS.ERROR, children: errorMessage && errorMessage })
  ] });
};
...
const Input = reactExports.forwardRef(
  ({ isError = false, ...props }, ref) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(TextInput, { ref, ...props, $isError: isError });
  }
);
const TextInput = dt.input(
  (props) => `
	width:100%;
	padding: 8px;
	border-radius: 2px;
...
const isNumberWithinRange = (value, maxLength) => {
  const regex = new RegExp(`^(?:\\d{1,${maxLength}})?$`);
  return regex.test(value);
};
const MESSAGE = {
  INVALID_NUMBER: "숫자만 입력 가능합니다.",
  INPUT_LENGTH_LIMIT: (maxLength) => `${maxLength}자리를 입력해주세요.`,
  MONTH_RANGE: "1~12까지의 숫자만 입력 가능합니다.",
  YEAR_RANGE: (year) => `${year}년 이상만 입력 가능합니다.`,
  MONTH_FORMAT: "MM/YY형태로 입력해주세요."
};
const INPUT_MAX_LENGTH$3 = 2;
const errorRule$2 = [
  {
    error: MESSAGE.INVALID_NUMBER,
    validate: (password) => !isNumberWithinRange(password, INPUT_MAX_LENGTH$3)
  }
];
const PasswordSection = ({
  ...
  const handleInput = (e) => {
    onChange(e);
    onValidate(errorRule$2, e);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberWrap$4, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { children: "비밀번호를 입력해 주세요" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { label: "비밀번호 앞 2자리", errorMessage, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        name: "password",
        type: "password",
        maxLength: INPUT_MAX_LENGTH$3,
        ...
        onBlur: (e) => onFocusout(
          e,
          INPUT_MAX_LENGTH$3,
          MESSAGE.INPUT_LENGTH_LIMIT(INPUT_MAX_LENGTH$3)
        )
      }
    ) })
  ] });
};
const CardNumberWrap$4 = dt.div`
  height: 130px;
`;
const CARD_COMPANY = {
...
const CardCompanySection = ({ onChange, name }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberWrap$3, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { children: "카드사를 선택해 주세요" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description$1, { children: "현재 국내 카드사만 가능합니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { name, onChange, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", hidden: true, children: "카드사를 선택해주세요" }),
      Object.entries(CARD_COMPANY).map(([key, value]) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: key, children: value.name }, key))
    ] })
  ] });
};
const CardNumberWrap$3 = dt.div`
  height: 130px;
`;
...
const errorRule$1 = [
  {
    error: MESSAGE.INVALID_NUMBER,
    validate: (cardNumber) => !isNumberWithinRange(cardNumber, INPUT_MAX_LENGTH$2)
  }
];
const CardNumberSection = ({
  ...
  const handleInput = (e, order) => {
    onChange(e, order);
    onValidate(errorRule$1, e, order);
  };
  reactExports.useEffect(() => {
    var _a, _b, _c, _d;
    ...
    const order = ORDER_LABEL$1[focusedIndex];
    if (((_a = errorMessage[order]) == null ? void 0 : _a.length) === 0 && ((_b = value[order]) == null ? void 0 : _b.length) === INPUT_MAX_LENGTH$2)
      (_d = (_c = inputRefs[focusedIndex + 1]) == null ? void 0 : _c.current) == null ? void 0 : _d.focus();
  }, [errorMessage, value]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberWrap$2, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description$1, { children: "본인 명의의 카드만 결제 가능합니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { label: "카드 번호", errorMessage: findErrorOrder(errorMessage), children: ORDER_LABEL$1.map((label, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        ref: inputRefs[idx],
        name: "cardNumber",
        ...
        onBlur: (e) => onFocusout(
          e,
          INPUT_MAX_LENGTH$2,
          MESSAGE.INPUT_LENGTH_LIMIT(INPUT_MAX_LENGTH$2),
          label
        )
      },
      label
...
const ExpirationDateSection = ({
  ...
  reactExports.useEffect(() => {
    ...
    if (((_a = errorMessage[order]) == null ? void 0 : _a.length) === 0 && ((_b = value[order]) == null ? void 0 : _b.length) === INPUT_MAX_LENGTH$1)
      (_d = (_c = inputRefs[focusedIndex + 1]) == null ? void 0 : _c.current) == null ? void 0 : _d.focus();
  }, [errorMessage, value]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberWrap$1, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description$1, { children: "월/년도(MMYY)를 순서대로 입력해 주세요." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { label: "유효기간", errorMessage: findErrorOrder(errorMessage), children: ORDER_LABEL.map((label, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        ref: inputRefs[idx],
        name: "expirationDate",
        ...
        onChange: (e) => handleInput(e, label),
        onBlur: (e) => onFocusout(e, INPUT_MAX_LENGTH$1, MESSAGE.MONTH_FORMAT, label)
      },
      label
    )) })
  ] });
...
const errorRule = [
  {
    error: MESSAGE.INVALID_NUMBER,
    validate: (cvc) => !isNumberWithinRange(cvc, INPUT_MAX_LENGTH)
  }
];
const CardCvcSection = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberWrap, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { label: "CVC", errorMessage, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        name: "cvcNumber",
...
const CardNumberWrap = dt.div`
  height: 130px;
`;
const Button = ({ children, bgColor = "#333", ...props }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$2, { bgColor, ...props, children });
};
...
const formatCardNumbers = (section, value) => {
  if (section === "third" || section === "fourth")
    return "•".repeat(value == null ? void 0 : value.length);
  return value;
};
const CardPreview = ({ cardNumbers, expirationDate, cardCompany }) => {
  var _a;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$1, { background: (_a = CARD_COMPANY[cardCompany]) == null ? void 0 : _a.color, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoWrap, { children: Object.entries(cardNumbers).map(([key, value]) => /* @__PURE__ */ jsxRuntimeExports.jsx(CardNumbers, { $blind: key === "third" || key === "fourth", children: formatCardNumbers(key, value) }, key)) }),
...
const useCardValidations = (initialData, initialMessages) => {
  const [isErrors, setIsErrors] = reactExports.useState(initialData);
  const [errorMessages, setErrorMessages] = reactExports.useState(initialMessages);
  const onError = (name, isError) => {
    setIsErrors((prev2) => ({ ...prev2, [name]: isError }));
  };
  const onValidate = (validateRule, e, order) => {
    const { value, name } = e.target;
    const matchedError = validateRule.find(
      (rule) => rule.validate(value, order)
    );
    if (order) {
      setErrorMessages((prev2) => {
        const updatedMessages = {
          ...
          [name]: {
            ...prev2[name],
            [order]: (matchedError == null ? void 0 : matchedError.error) ?? ""
          }
        };
    ...
    setErrorMessages((prev2) => {
      const updatedMessages = {
        ...prev2,
        [name]: (matchedError == null ? void 0 : matchedError.error) ?? ""
      };
  ...
  const onFocusout = (e, maxLength, message, order) => {
    const { value, name } = e.target;
    if (value.length < maxLength) {
      ...
      setErrorMessages((prev2) => ({ ...prev2, [name]: message }));
      onError(name, true);
    }
  };
  return { isErrors, onError, onValidate, onFocusout, errorMessages };
};
const useAutoStep = (formData, isErrors) => {
  const [step, setStep] = reactExports.useState(1);
  const [isButtonVisible, setIsButtonVisible] = reactExports.useState(false);
  const maxStepRef = reactExports.useRef(1);
  const validationCheckers = {
    cardNumber: () => !isErrors.cardNumber && Object.values(formData.cardNumber).every((v2) => v2.length === 4),
    cardCompany: () => !isErrors.cardCompany && !!formData.cardCompany,
    expirationDate: () => !isErrors.expirationDate && Object.values(formData.expirationDate).every((v2) => v2.length === 2),
    cvcNumber: () => !isErrors.cvcNumber && formData.cvcNumber.length === 3,
    password: () => !isErrors.password && formData.password.length === 2
  };
  const calculateStep = () => {
    var _a, _b, _c, _d, _e2;
    if (!((_a = validationCheckers.cardNumber) == null ? void 0 : _a.call(validationCheckers))) return 1;
    if (!((_b = validationCheckers.cardCompany) == null ? void 0 : _b.call(validationCheckers))) return 2;
    if (!((_c = validationCheckers.expirationDate) == null ? void 0 : _c.call(validationCheckers))) return 3;
    if (!((_d = validationCheckers.cvcNumber) == null ? void 0 : _d.call(validationCheckers))) return 4;
    if (!((_e2 = validationCheckers.password) == null ? void 0 : _e2.call(validationCheckers))) return 5;
    return 6;
  };
  reactExports.useEffect(() => {
...
const Main = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MainContainer, { children: [
    ...
    step >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(CardCompanySection, { onChange, name: "cardCompany" }),
    ...
    isButtonVisible && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
...
const Confirm = () => {
  ...
  const navigate = useNavigate();
  if (!location.state) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "잘못된 경로로 들어오셨습니다." });
  const { firstSection, cardCompany } = location.state;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "./images/checkIcon.png", alt: "체크표시" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Description, { children: [
      firstSection,
      "로 시작하는",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      (_a = CARD_COMPANY[cardCompany]) == null ? void 0 : _a.name,
      "가 등록되었어요."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => navigate(-1), children: "확인" })
  ] });
};
